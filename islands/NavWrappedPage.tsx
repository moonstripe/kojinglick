    ...
    return (
        <div class={tw`mt-4`}>
            ...
            <div class={tw`flex flex-row`}>
                <div class={tw`ml-0 mr-auto`}>
                    <Logo setter={setMode} />
                </div>
                <div class={tw`ml-auto mr-0 flex flex-row`}>
                    <a class={tw`my-auto`} href={`https://www.linkedin.com/in/kojinglick`} target="_blank" rel="noopener noreferrer">
                        <div class={tw`flex flex-row`}>
                    ...
                    <a class={tw`my-auto`} href={`https://twitter.com/kojinglick`} target="_blank" rel="noopener noreferrer">
                        <div class={tw`flex flex-row`}>
                    ...
                    <a class={tw`my-auto`} href={`mailto:kojinglick@gmail.com`} target="_blank" rel="noopener noreferrer">
                        <div class={tw`flex flex-row`}>
